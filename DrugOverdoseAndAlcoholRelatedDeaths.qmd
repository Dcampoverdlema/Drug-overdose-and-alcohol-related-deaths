...
The linear model has the least amount of error compared to the others but could make an argument to use other models like random forest to find predictors. 
