...
health_data_alc <- kNN(health_data_alc, k = 5, imp_var = FALSE)
...
health_data_drug <- kNN(health_data_drug, k = 5, imp_var = FALSE)
...
ggplot(selected_data, aes(x = excessive_drinking_raw_value, y = alcohol_impaired_driving_deaths_raw_value)) +
  ...
  scale_color_manual(values = c("Low" = "lightc", "Lower-Middle" = "lightskyblue2", "Upper-Middle"= "cadetblue", "High" = "darkblue")) 
